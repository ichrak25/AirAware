...
/**
 * Identity entity for AirAware users and system actors.
 * Mirrors the SmartHome Identity structure but adapted for the AirAware domain.
 */
@Entity("identities")
public class Identity implements Serializable, Principal {
    ...
    public boolean isAccountActivated() { return isAccountActivated; }
